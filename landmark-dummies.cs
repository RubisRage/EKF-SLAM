        ...
        public landmark[] ExtractLineLandmarks(double[] laserdata, double[] robotPosition) {
            ...
            */
            ...
            while (noTrials < MAXTRIALS && totalLinepoints > MINLINEPOINTS) {
                ...
                //Initial version chooses entirely randomly.
                Now choose
                ...
                int[] consensusPoints = new int[laserdata.Length]; int totalConsensusPoints = 0; int[] newLinePoints = new int[laserdata.Length]; int totalNewLinePoints = 0; double x = 0, y = 0; double d = 0;
...
public int AddToDB(landmark lm) {
    ...
    //{
    ((landmark) landmarkDB[DBSize]).pos[0] = lm.pos[0];
    //set landmark coordinates
    ((landmark) landmarkDB[DBSize]).pos[1] = lm.pos[1];
    //set landmark coordinates
